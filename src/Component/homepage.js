          ...
          <div className="home-banner-left">
            <p className="banner-title f1">
              <span className="one">Inn</span><span className="two">ova</span><span className="three">ting</span> <span
                className="four">Tec</span><span className="five-second">hno</span><span className="five">logi</span><span
                className="six">es</span>
              </p>
            <p className="banner-subtitle f1">
      ...
      <div className="row mt-60 common-padding-25">
        ...
        <div className="col-lg-3 col-md-6 col-sm-6 col-6">
          <div className="product-card">
            ...
            <div className="product-card-content">
              <p className="product-card-heading">
                Integrated Estate<br/>Management System
              </p>
              <p className="common-para">
    ...
    <div className="container common-padding-25">
      <div className="row">
        <div className="col-lg-6 mx-auto text-center">
          ...
          <p className="common-para">
            Explore our case studies to see how we've helped our clients achieve their goals with our innovative solutions.
          </p>
        </div>
      </div>
      <div className="row case-study-card-row">
        <div className="col-lg-3 col-3">
          <div className="case-study-card">
            <div className="upper-icons">
              <div className="left">
                <img src="/images/expand-icon.gif" className="img-fluid" alt="" />
              </div>
              <div className="right">
                <img src="/images/expand-icon.gif" className="img-fluid" alt="" />
              </div>
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/1.png" className="img-fluid" alt=""/>
                ...
                <div className="col-lg-12">
                  <div className="second-view-wrapper">
                    <div className="left">
                      ...
                      <div className="case-study-second-content">
                        <p className="case-study-second-content-heading">National Hydrographic</p>
                        <p className="common-para">
                          The National Hydrographic Office (NHO) is the organization responsible for surveying and
                          charting India's waterways, and their website is a crucial tool for sharing information with
                          stakeholders and the public. When the NHO approached our team for help with a website
        ...
        <div className="col-lg-3 col-3">
          <div className="case-study-card">
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/3.png" className="img-fluid" alt=""/>
              </div>
              <div className="case-study-heading">
                Ishaanav
              </div>
                ...
                <div className="col-lg-12">
                  <div className="second-view-wrapper">
                    <div className="left">
                      ...
                      <div className="case-study-second-content">
                        <p className="case-study-second-content-heading">Ishaanav Nutraceuticals Pvt Ltd</p>
                        <p className="common-para">
                          The contract pharmaceutical manufacturing business client faced obstacles in managing customer
                          relationships, purchase orders, production processes, and invoicing. Their operations relied
                          on manual systems that were laborious, error-prone, and lacked real-time insights.
                        </p>
                        <div className="right">
                          <div>
        ...
        <div className="col-lg-3 col-3">
          <div className="case-study-card">
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/4.png" className="img-fluid" alt=""/>
              </div>
              <div className="case-study-heading">
        ...
        <div className="col-lg-3 col-3">
          <div className="case-study-card">
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/5.png" className="img-fluid" alt=""/>
              </div>
              <div className="case-study-heading">
                NRCMS
              </div>
                ...
                <div className="col-lg-12">
                  <div className="second-view-wrapper">
                    <div className="left">
                      ...
                      <div className="case-study-second-content">
                        <p className="case-study-second-content-heading">Northern Railways</p>
                        <p className="common-para">
        ...
        <div className="col-lg-3 col-3">
          <div className="case-study-card">
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/6.png" className="img-fluid" alt=""/>
              </div>
              <div className="case-study-heading">
                ...
                <div className="col-lg-12">
                  <div className="second-view-wrapper">
                    <div className="left">
                      ...
                      <div className="case-study-second-content">
                        <p className="case-study-second-content-heading">JGC Gulf International Co. Ltd.</p>
                        <p className="common-para">
                          (JGC Gulf) is a leading engineering, procurement, and construction company that specializes in
                          delivering innovative solutions for the oil and gas, petrochemical, and other industries. When
                          JGC Gulf approached our team for help with their website redesign, we were excited to take on
                          the challenge.
                        </p>
                        <div className="right">
                          <div>
                ...
                <div className="col-lg-12">
                  <div className="second-view-wrapper">
                    <div className="left">
                      ...
                      <div className="case-study-second-content">
                        <p className="case-study-second-content-heading">The Pioneer Edge</p>
                        <p className="common-para">
        ...
        <div className="col-lg-3- col-3">
          <div className="case-study-card">
            ...
            <div className="first-view">
              <div className="case-study-pic">
                <img src="/images/case-study/8.png" className="img-fluid" alt=""/>
              </div>
              <div className="case-study-heading">
                INCA India
              </div>

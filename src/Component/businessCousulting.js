...
const BusinessCousulting = () => {
  return (
    <>
        <section className="about-who-we-are repeated-hero-banner services-businessConsulting-development">
...
Lower Infrastructure Total Cost of Ownership (TCO) with Docker
            ...
            <div className='row'>
                ...
                <button className=" download-brochure border-0">
                                    <span className="icon">
...
export default BusinessCousulting
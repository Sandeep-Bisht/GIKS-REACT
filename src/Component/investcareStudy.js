            ...
            <div className="col-md-8">
              <div className="text">
                <h2 className="common-heading">Investcare</h2>
                 ...
                 <h3 className="sub-pages-heading1">Key Features of Investcare:</h3>
                 ...
                 <h3 className="sub-pages-heading1 mb-0">Marketing Strategy:</h3>
                 <p className='common-para'>
                 ...
                 <h3 className="sub-pages-heading1 mb-0">Impact on the Investment Industry:</h3>
                 <p className='common-para'>

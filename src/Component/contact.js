                  ...
                  <div className="contact-single-left">
                     ...
                     <ul>
                        <li className="contact-link">
                           ...
                           <div> <span className="contact-link-info common-para">
                              GIKS INDIA PVT LTD,2nd floor,Sujok<br/>BuildingMansarovar Colony,Ballupur<br/>
                  ...
                  <div className="contact-single-right">
                     <form>
                        ...
                        <p className="common-para">We’ll get back to you as soon as possible
                           ...
                           <div className="col-md-12">
                              <a href="#" className="common-btn mt-2 d-inline-block">
                              Submit
                              </a>
                           </div>
                        </div>
               ...
               <div className="col-md-12">
                  <div className="map-box">
                     <iframe
                        ...
                        width="100%" height="450" style={{border: "0px"}}  allowfullscreen="" loading="lazy"

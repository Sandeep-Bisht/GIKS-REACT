...
setBlogImage(blogDetail)
    ...
    console.log(blogDetails,"check blog details",blogImage)
    return (
        <>
                                        ...
                                        <div className="single-blog-detail-card">
                                            ...
                                            <div className="row mt-lg-4">
                                                <div className="col-md-12">
                                                    ...
                                                    <p className="common-para">REST, which stands for Representational State Transfer, is a widely used architectural style for building web services that communicate over HTTP. RESTful APIs, also known as REST APIs, are a type of API that adhere to the principles of REST.</p>
                                                </div>
                                                <div className="col-md-12">
                                                    <p className="blog-title mb-1">What is a REST API?</p>
                                                    <p className="common-para">A REST API is a web-based application programming interface (API) that uses HTTP requests to perform four basic operations: Create (POST), Read (GET), Update (PUT), and Delete (DELETE). These operations are often referred to as CRUD operations.
                                                        REST APIs are stateless, meaning that each request contains all the information needed to complete the request, including authentication credentials, if necessary. This allows for scalability and reliability, as the server doesn't need to maintain any session state between requests.</p>
                                                </div>
                                                <div className="col-md-12">
                                                    <p className="blog-title mb-1">How Does a REST API Work?</p>
                                                    <p className="common-para">A REST API uses a set of rules or constraints to interact with resources on a server. These constraints are defined by the architectural style, which dictates how data should be transmitted and what operations are allowed. The most important constraint of REST is the use of HTTP methods to interact with resources. Each HTTP method corresponds to a specific CRUD operation:</p>
                                                    <ul className="ps-1 ms-2">
                                                        <li className="common-para">GET: retrieves a resource or a list of resources</li>
                                                        <li className="common-para">POST: creates a new resource</li>
                                                        <li className="common-para">PUT: updates an existing resource</li>
                                                        <li className="common-para">DELETE: deletes a resource</li>
                                                    </ul>
                                                    <p className="common-para">
                                                        When a client sends an HTTP request to a REST API, it includes a URL that identifies the resource and the HTTP method to be used. The server responds with an HTTP status code that indicates whether the request was successful or not.
                                                    </p>
                                                    <p className="common-para">
                                                        For example, suppose we have a REST API that provides information about books. A client could use a GET request to retrieve a list of all the available books, like this:
                                                    </p>
                                                </div>
                                                <div className="col-md-12">
                                                    <img src="/images/blog-single/code1.jpg" className="img-fluid" />
                                                </div>
                                                <div className="col-md-12 mt-4">
                                                    <p className="common-para">The server would respond with a JSON representation of the list of books, along with an HTTP status code indicating success:</p>
                                                </div>
                                                <div className="col-md-12">
                                                    <img src="/images/blog-single/code2.jpg" className="img-fluid" />
                                                </div>
                                                <div className="col-md-12 mt-lg-3">
                                                    <p className="blog-title mb-1">Advantages of REST APIs:</p>
                                                    <p className="common-para">There are several advantages to using REST APIs:</p>
                                                </div>
                                                <div className="col-md-12">
                                                    <ol className="ps-1 ms-2">
                                                        <li className="common-para">Scalability: REST APIs are stateless, meaning that they don't maintain any session state between requests. This makes them highly scalable, as the server doesn't need to keep track of any client state</li>
                                                        <li className="common-para">Flexibility: REST APIs can be used to interact with a wide variety of resources, including databases, files, and other services.</li>
                                                        <li className="common-para">Simplicity: Because REST APIs use HTTP methods to interact with resources, they are simple to learn and easy to use.</li>
                                                        <li className="common-para">
                                                            Wide adoption: REST APIs have become the de facto standard for building web services, meaning that there are many tools and frameworks available for working with them.
                                                        </li>
                                                        <li className="common-para">Cacheable: REST APIs can be made cacheable, which can improve performance and reduce server load.</li>
                                                    </ol>
                                                </div>
                                                <div className="col-md-12">
                                                    <p className="blog-title mb-1">Conclusion:</p>
                                                    <p className="common-para mb-2">REST APIs have become the standard for building web services that
                                                        interact with resources over HTTP. They are simple to learn, highly scalable, and flexible enough to
                                                        work with a wide variety of resources.</p>
                                                    <p className="common-para">If you're building a web service that needs to interact with resources, consider using a REST API. It will make your service simpler, more scalable, and more widely adopted by other developers.</p>
                                                </div>
                                                <div className="col-md-12">
                                                    <ul className="social-link-list ps-0 list-unstyled">
                                                        <li><a href="#"><svg width="12" height="21" viewBox="0 0 12 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.7188 7.8125H7.8125V4.6875C7.8125 3.825 8.5125 3.90625 9.375 3.90625H10.9375V0H7.8125C6.5693 0 5.37701 0.49386 4.49794 1.37294C3.61886 2.25201 3.125 3.4443 3.125 4.6875V7.8125H0V11.7188H3.125V20.3125H7.8125V11.7188H10.1562L11.7188 7.8125Z" fill="#FAFAFA" />
                                                        </svg>
                                                        </a></li>
                                                        <li><a href="#">
                                                            <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M15.1038 1.70846C14.5556 1.95112 13.9743 2.11035 13.379 2.18085C14.0015 1.80733 14.4776 1.21776 14.6973 0.518332C14.1084 0.867352 13.4645 1.11377 12.7931 1.24706C12.3817 0.805392 11.8467 0.497972 11.2579 0.364899C10.6692 0.231826 10.054 0.279278 9.4926 0.501064C8.93122 0.722849 8.44971 1.10867 8.11088 1.60821C7.77205 2.10774 7.59163 2.6978 7.59316 3.3014C7.59243 3.53185 7.61823 3.76163 7.67006 3.98618C6.4756 3.92628 5.30707 3.61594 4.24029 3.07529C3.17351 2.53465 2.2323 1.77578 1.47773 0.847906C1.09174 1.50934 0.973052 2.29326 1.14595 3.03931C1.31885 3.78537 1.77027 4.43717 2.40786 4.86138C1.93015 4.84641 1.46301 4.71706 1.04563 4.4842V4.52082C1.04563 5.97827 2.08195 7.19403 3.45518 7.46868C3.01341 7.58923 2.54987 7.60677 2.10026 7.51994C2.29229 8.1166 2.66579 8.63843 3.16865 9.01262C3.6715 9.38681 4.27862 9.59468 4.9053 9.60724C4.282 10.0972 3.56818 10.4593 2.80471 10.673C2.04123 10.8866 1.24311 10.9476 0.456055 10.8523C1.78534 11.7055 3.36363 12.1999 5.06276 12.1999C10.5923 12.1999 13.6134 7.62248 13.6134 3.64928C13.6134 3.52112 13.6134 3.39295 13.606 3.26112C14.192 2.84 14.7046 2.30902 15.1074 1.70846H15.1038Z" fill="white" />
                                                            </svg>
